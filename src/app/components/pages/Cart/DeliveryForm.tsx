...
interface DeliveryFormProps {
  deliveryInfo: { governorate: string; district: string; address: string; phone: string; };
...
export function DeliveryForm({ deliveryInfo, setDeliveryInfo, timeSlot, setTimeSlot, onBack, onNext }: DeliveryFormProps) {
  return (
